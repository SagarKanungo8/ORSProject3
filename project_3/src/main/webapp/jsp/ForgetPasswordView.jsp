...
.p4{
background-image: url('<%=ORSView.APP_CONTEXT%>/img/yellowishuserctl.jpg');
	background-size: 100%;
		padding-top: 8%;
			...
			<div class="row pt-5">
				...
				<div class="col-md-4">
					<div class="card input-group-addon grad">
						<div class="card-body">
							<h3 class="text-center default-text text-black">Forget Your Password?</h3>
							<p class="text-center default-text text-black" style="font-size:11px;"> Submit your Email Address and we will Send You password</p>
