...
.reg {
	  background: #a866ea;
        ...
        background: -webkit-linear-gradient(to right, rgba(168,102,234,1), rgba(36,30,41,1)); 
  
       background: linear-gradient(to right, rgba(168,102,234,1), rgba(36,30,41,1)) 
}
...
<body>
	...
	<nav class="navbar navbar-expand-lg reg fixed-top"> 
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			...
			<!-- ---------------------------------------------------------------PAYMENTMODEL-------------------------------------- -->
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Payment</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PAYMENT_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Pyment
						</a> <a class="dropdown-item" href="<%=ORSView.PAYMENT_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Payment List</a>
					</div></li>
				 ...
				 <!-- --------------------------------------------------------------ORDERMODEL-------------------------------------------- -->
				   <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						</a> <a class="dropdown-item" href="OrderListCtl"><i
				  ...
				  <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.BANK_CTL%>"> <i
							class="fas fa-user-tie"></i>Add Customer
